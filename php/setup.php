...
#
define("__CA_DB_PORT__", getenv('OPENSHIFT_MYSQL_DB_PORT') );
define("__CA_DB_HOST1__", getenv('OPENSHIFT_MYSQL_DB_HOST') );
define("__CA_DB_HOST__", __CA_DB_HOST1__:__CA_DB_PORT__ );
